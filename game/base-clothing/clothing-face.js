...
function initFace() {
	...
	const clothing = [
		...
		},
		{
			...
			colour_sidebar: 1,
			colour_combat: 0,
			type: ["fetish", "gag", "open"],
			gender: "n",
			warmth: 0,
			cost: 10000,
			description: "Keeps your mouth open for access.",
			shop: ["adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		},
		{
			...
			warmth: 0,
			cost: 15000,
			description: "Keeps your mouth open for access and filled when done.",
			shop: [], //planned for "adult"
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
			cursed: 0,
