...
function initHandheld() {
	...
	const clothing = [
		...
		},
		{
			...
			plural: 0,
			colour: 0,
			colour_options: ["yellow", "red", "blue"],
			colour_sidebar: 1,
			type: ["prop", "food"],
			shop: [],
			gender: "n",
		...
		},
		{
			...
			shop: [],
			gender: "n",
			description: "Carved from sweetest marrow. Nourishes the soul, if you'd just let it slip between your ribs.",
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
			accessory_colour_sidebar: 0,
