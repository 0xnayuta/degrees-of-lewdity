...
function initHandheld() {
	...
	const clothing = [
		...
		new ClothesItem({
			index: 33,
			slot: "handheld",
			name: "magnet fishing rod",
			name_cap: "Magnet fishing rod",
			variable: "magnet fishing rod",
			state: 0,
			state_base: 0,
			integrity: 120,
			integrity_max: 120,
			...
			colour_options: [],
			colour_sidebar: 0,
			type: ["fishing_rod_magnet"],
			gender: "n",
			femininity: 0,
			warmth: 0,
			cost: 3000,
			description: "A strong magnet on a line. Catches anything metal, which fish are not.",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
			...
			location: 0,
			zIndex: "head",
			iconFile: "magnet-fishing-rod.png",
			accIcon: 0,
			holdingPreventsRightCover: 1,
		}),
	];
