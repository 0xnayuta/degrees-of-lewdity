...
function initUpper() {
	...
	const clothing = [
		...
		},
		{
			...
			plural: 1,
			colour: 0,
			colour_options: ["original", "denim", "light blue", "black", "blue steel", "grey", "custom"],
			colour_combat: "blue",
			colour_sidebar: 1,
			exposed: 0,
			exposed_base: 0,
