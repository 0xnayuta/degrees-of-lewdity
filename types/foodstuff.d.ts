...
declare global {
	...
	export interface FoodstuffTendingData {
		...
		affected_by_tending_skill?: boolean; // If true, the number of items harvested gets increased by the tending skill. Only applies to tending_pick, and not to tending_harvest nor tending_give.
	}
