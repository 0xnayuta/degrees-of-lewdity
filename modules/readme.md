...
Javascript files are inserted into the head of the HTML file and are executed instantly. This will occur before most, if not all, of the other processes for the game, including SugarCube.
